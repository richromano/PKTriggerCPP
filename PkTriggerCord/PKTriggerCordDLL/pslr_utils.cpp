...
PKTRIGGERCORDDLL_API double timeval_diff_sec(struct timeval *t2, struct timeval *t1) {
...
PKTRIGGERCORDDLL_API void sleep_sec(double sec) {
    int i;
...
PKTRIGGERCORDDLL_API pslr_rational_t parse_aperture(char *aperture_str) {
    ...
    aperture.nom = (int32_t)F * 10;
    aperture.denom = (int32_t)10;

    return aperture;
}

PKTRIGGERCORDDLL_API pslr_rational_t parse_shutter_speed(char *shutter_speed_str) {
    char C;
    float F = 0;
