...
size_t str_comparison_i (const char *s1, const char *s2, size_t n) {
    if ( s1 == NULL ) {
        return s2 == NULL ? 0 : -(*s2);
    }
    if (s2 == NULL) {
...
PKTRIGGERCORDDLL_API pslr_color_space_t pslr_get_color_space( char *str ) {
    return (pslr_color_space_t)find_in_array( pslr_color_space_str, sizeof(pslr_color_space_str)/sizeof(pslr_color_space_str[0]),str);
}
...
PKTRIGGERCORDDLL_API pslr_af_mode_t pslr_get_af_mode( char *str ) {
    return (pslr_af_mode_t)find_in_array( pslr_af_mode_str, sizeof(pslr_af_mode_str)/sizeof(pslr_af_mode_str[0]),str);
}
...
PKTRIGGERCORDDLL_API pslr_ae_metering_t pslr_get_ae_metering( char *str ) {
    return (pslr_ae_metering_t)find_in_array( pslr_ae_metering_str, sizeof(pslr_ae_metering_str)/sizeof(pslr_ae_metering_str[0]),str);
}
...
PKTRIGGERCORDDLL_API pslr_flash_mode_t pslr_get_flash_mode( char *str ) {
    return (pslr_flash_mode_t)find_in_array( pslr_flash_mode_str, sizeof(pslr_flash_mode_str)/sizeof(pslr_flash_mode_str[0]),str);
}
...
PKTRIGGERCORDDLL_API pslr_drive_mode_t pslr_get_drive_mode( char *str ) {
    return (pslr_drive_mode_t)find_in_array( pslr_drive_mode_str, sizeof(pslr_drive_mode_str)/sizeof(pslr_drive_mode_str[0]),str);
}
...
PKTRIGGERCORDDLL_API pslr_af_point_sel_t pslr_get_af_point_sel( char *str ) {
    return (pslr_af_point_sel_t)find_in_array( pslr_af_point_sel_str, sizeof(pslr_af_point_sel_str)/sizeof(pslr_af_point_sel_str[0]),str);
}
...
PKTRIGGERCORDDLL_API pslr_jpeg_image_tone_t pslr_get_jpeg_image_tone( char *str ) {
    return (pslr_jpeg_image_tone_t)find_in_array( pslr_jpeg_image_tone_str, sizeof(pslr_jpeg_image_tone_str)/sizeof(pslr_jpeg_image_tone_str[0]),str);
}
...
PKTRIGGERCORDDLL_API pslr_white_balance_mode_t pslr_get_white_balance_mode( char *str ) {
    return (pslr_white_balance_mode_t)find_in_array( pslr_white_balance_mode_str, sizeof(pslr_white_balance_mode_str)/sizeof(pslr_white_balance_mode_str[0]),str);
}
