...
PKTRIGGERCORDDLL_API void pslr_camera_close(pslr_handle_t camhandle) {
    pslr_disconnect(camhandle);
    pslr_shutdown(camhandle);
}

PKTRIGGERCORDDLL_API pslr_handle_t pslr_camera_connect( char *model, char *device, int timeout, char *error_message ) {
