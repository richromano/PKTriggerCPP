...
PKTRIGGERCORDDLL_API int pslr_get_status(pslr_handle_t h, pslr_status *sbuf);
PKTRIGGERCORDDLL_API int pslr_get_status_buffer(pslr_handle_t h, uint8_t *st_buf);
PKTRIGGERCORDDLL_API int pslr_get_settings_json(pslr_handle_t h, pslr_settings *ps);
PKTRIGGERCORDDLL_API int pslr_get_settings_buffer(pslr_handle_t h, uint8_t *st_buf);
...
PKTRIGGERCORDDLL_API int pslr_set_jpeg_image_tone(pslr_handle_t h, pslr_jpeg_image_tone_t image_mode);
...
PKTRIGGERCORDDLL_API int pslr_get_model_max_jpeg_stars(pslr_handle_t h);
int pslr_get_model_jpeg_property_levels(pslr_handle_t h);
PKTRIGGERCORDDLL_API int pslr_get_model_status_buffer_size(pslr_handle_t h);
PKTRIGGERCORDDLL_API int pslr_get_model_fastest_shutter_speed(pslr_handle_t h);
PKTRIGGERCORDDLL_API int pslr_get_model_base_iso_min(pslr_handle_t h);
PKTRIGGERCORDDLL_API int pslr_get_model_base_iso_max(pslr_handle_t h);
